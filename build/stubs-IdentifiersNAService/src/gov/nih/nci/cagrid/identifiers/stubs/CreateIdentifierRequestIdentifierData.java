/**
 * CreateIdentifierRequestIdentifierData.java
 *
...
public class CreateIdentifierRequestIdentifierData  implements java.io.Serializable {
    private namingauthority.IdentifierData identifierData;

    public CreateIdentifierRequestIdentifierData() {
    }
    ...
    /**
     * Gets the identifierData value for this CreateIdentifierRequestIdentifierData.
     * 
    ...
    /**
     * Sets the identifierData value for this CreateIdentifierRequestIdentifierData.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CreateIdentifierRequestIdentifierData)) return false;
        CreateIdentifierRequestIdentifierData other = (CreateIdentifierRequestIdentifierData) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CreateIdentifierRequestIdentifierData.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://identifiers.cagrid.nci.nih.gov/IdentifiersNAService", ">>CreateIdentifierRequest>identifierData"));
