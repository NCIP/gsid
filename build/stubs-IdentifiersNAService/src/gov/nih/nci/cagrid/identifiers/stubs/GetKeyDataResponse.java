...
public class GetKeyDataResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the keyNameData value for this GetKeyDataResponse.
     * 
     * @return keyNameData
     */
    ...
    /**
     * Sets the keyNameData value for this GetKeyDataResponse.
     * 
     * @param keyNameData
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetKeyDataResponse)) return false;
        GetKeyDataResponse other = (GetKeyDataResponse) obj;
        ...
        _equals = true && 
            ((this.keyNameData==null && other.getKeyNameData()==null) || 
             (this.keyNameData!=null &&
              this.keyNameData.equals(other.getKeyNameData())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getKeyNameData() != null) {
            _hashCode += getKeyNameData().hashCode();
        }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetKeyDataResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://identifiers.cagrid.nci.nih.gov/IdentifiersNAService", ">GetKeyDataResponse"));
