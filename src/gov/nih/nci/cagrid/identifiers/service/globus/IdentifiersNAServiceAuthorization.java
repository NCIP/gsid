...
public class IdentifiersNAServiceAuthorization implements PDP {
	...
	public void authorizeAddSite(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
		
	}
	   				
	public void authorizeGenerateIdentifiers(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
		
	}
	   				
	public void authorizeGetParentHierarchy(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
		
	}
	   				
	public void authorizeGetChildHierarchy(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("getMultipleResourceProperties")){
			...
			return true;
		} else if(operation.getLocalPart().equals("addSite")){
			authorizeAddSite(peerSubject, context, operation);
			return true;
		} else if(operation.getLocalPart().equals("generateIdentifiers")){
			authorizeGenerateIdentifiers(peerSubject, context, operation);
			return true;
		} else if(operation.getLocalPart().equals("getParentHierarchy")){
			authorizeGetParentHierarchy(peerSubject, context, operation);
			return true;
		} else if(operation.getLocalPart().equals("getChildHierarchy")){
			authorizeGetChildHierarchy(peerSubject, context, operation);
			return true;
