/**
 * IdentifiersNAServiceResourceProperties.java
 *
...
public class IdentifiersNAServiceResourceProperties  implements java.io.Serializable {
    private gov.nih.nci.cagrid.metadata.ServiceMetadata serviceMetadata;

    public IdentifiersNAServiceResourceProperties() {
    }
    ...
    /**
     * Gets the serviceMetadata value for this IdentifiersNAServiceResourceProperties.
     * 
    ...
    /**
     * Sets the serviceMetadata value for this IdentifiersNAServiceResourceProperties.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof IdentifiersNAServiceResourceProperties)) return false;
        IdentifiersNAServiceResourceProperties other = (IdentifiersNAServiceResourceProperties) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(IdentifiersNAServiceResourceProperties.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://identifiers.cagrid.nci.nih.gov/IdentifiersNAService", ">IdentifiersNAServiceResourceProperties"));
